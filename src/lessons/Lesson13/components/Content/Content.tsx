...
function Content() {
//3 шаг. Вызываем хук useContext который передаем в контекст, который был создан на 1-м шаге
//При вызове хука useContext он вернет все данные которые быи переданы в value провайдера на 2-м шаге
